...
def compare_for_conflicts(db_path: str, main_db: str, db_password: str):
    db_name = db_path.stem
    dbfiles = list(db_path.parent.glob(f"{db_name}*.kdbx"))
    ...
    if conflicts:
        ...
        conflicting_dbs = {
            dbfile.name: PyKeePass(dbfile, password=db_password) for dbfile in dbfiles if dbfile != db_path
        }
